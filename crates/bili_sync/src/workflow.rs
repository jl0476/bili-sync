...
use crate::utils::model::{
    create_pages, create_videos, filter_unfilled_videos, filter_unhandled_video_pages, mark_cross_source_duplicates,
    set_video_models_invalid, update_pages_model, update_video_detail_models, update_videos_model,
};
...
pub async fn download_unprocessed_videos(
    ...
    let duplicate_count =
        mark_cross_source_duplicates(video_source.filter_expr(), connection, &video_source.display_name()).await?;
